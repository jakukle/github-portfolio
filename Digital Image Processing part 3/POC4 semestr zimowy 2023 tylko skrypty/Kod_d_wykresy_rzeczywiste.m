clc
clear all
imtr1z = imread('C:\Users\Krzysztof\Desktop\POC4\Zad1_2\Obrazy rzeczywiste\zakretkax.png');
imtr1 = im2bw(imtr1z);
imkolo1z = imread('C:\Users\Krzysztof\Desktop\POC4\Zad1_2\Obrazy rzeczywiste\obudowax.png');
imkolo1 = im2bw(imkolo1z);
imkwad1z = imread('C:\Users\Krzysztof\Desktop\POC4\Zad1_2\Obrazy rzeczywiste\zakretkax.png');
...
legend('Zakretka','Obudowa','Location','southoutside','Orientation','horizontal');
